      ...
      <div className="flex flex-col lg:flex-row gap-11">
        <div className="w-full lg:w-7/10">
          ...
          <div className="mb-8 sm:mb-12">
            <Image
              src={autonomousCarData.image}
              alt={autonomousCarData.title}
          ...
          <div className="my-8">
            ...
            <div className="p-3">
              <div className="space-y-4">
                {autonomousCarData.overview.map((section) => (
          ...
          <div className="my-8 rounded-lg">
            ...
            <div className="text-base text-gray-700 leading-relaxed mb-1">
              <p className="mb-4">{autonomousCarData.about}{!showFullDescription && <span> ...</span>}</p>
              {showFullDescription && (
                <>
                  <strong className="text-lg font-semibold">Top Projects You Will Build:</strong>
                  <ul className="list-none mt-4 space-y-1">
                    {autonomousCarData.projects.map((project, idx) => (
          ...
          <div className="my-12">
            ...
            <div className="block md:hidden">
              {autonomousCarData.whoIsThisFor.map((who, idx) => (
            ...
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 my-4">
              <div className="md:flex md:gap-6">
                <div className="flex-shrink-0 md:block flex flex-col items-center mb-6 md:mb-0">
                  <Image src={autonomousCarData.instructor.image} alt={autonomousCarData.instructor.name} width={100} height={120} className="rounded-lg" />
                </div>
                <div className="md:flex md:flex-col">
                  <div className="text-center md:text-left">
                    <h3 className="text-lg sm:text-xl font-semibold mb-2">{autonomousCarData.instructor.name}</h3>
                    <p className="text-sm sm:text-base text-gray-500 mb-2 flex items-center justify-center md:justify-start">
                      <ClockIcon className="w-4 h-4 mr-2" />
                      <strong>{autonomousCarData.instructor.experience}</strong>
                    </p>
                    <p className="text-sm sm:text-base text-gray-500 mb-2 flex items-center justify-center md:justify-start">
                      <UsersIcon className="w-4 h-4 mr-2" />
                      <strong>{autonomousCarData.instructor.learners}</strong>
                    </p>
                  </div>
                </div>
              </div>
              <p className="mt-4 text-gray-700 text-sm sm:text-base">{autonomousCarData.instructor.bio}</p>
            </div>
          </div>
