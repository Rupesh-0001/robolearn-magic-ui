...
import { CheckCircle as CheckIcon, ChevronUp as ChevronUpIcon, ChevronDown as ChevronDownIcon, Users as UsersIcon, Clock as ClockIcon, Cpu as CpuIcon, ChartBar as ChartBarIcon, RocketLaunch as RocketLaunchIcon, ChevronLeft, ChevronRight } from 'lucide-react';
import LevelIcon from '@/public/beginner-icon.svg';
import DurationIcon from '@/public/clock-icon.svg';
import LanguageIcon from '@/public/globe-icon.svg';
import AccessIcon from '@/public/accessIcon.svg';
import CertificateIcon from '@/public/certificate-icon.svg';
            ...
            <div className="p-3">
              <div className="space-y-4">
                  ...
                  >
                    <ul className="list-disc pl-5 text-sm sm:text-base">
                      ...
                      <li className="flex items-center py-1">
                        ...
                        Reflex agents and rule engines
                      </li>
                      <li className="flex items-center py-1">
                ...
                >
                  ...
                  >
                    <span className="text-sm sm:text-base">
                      3. Memory and Retrieval Systems
                    </span>
                    {openLecture === "memory" ? (
                      <ChevronUpIcon className="h-5 w-5" />
                    ) : (
                  ...
                  <div className="mb-4">
                    ...
                    <ul className="list-none mt-4 space-y-1">
                      <li className="flex items-center">
                        ...
                        <span className="text-sm sm:text-base">
                          Reflex Agent + Rule Engine (Level 1)
                        </span>
                      </li>
                      <li className="flex items-center">
                        <span className="hidden sm:inline text-green-500 mr-2">
                      ...
                      <li className="flex items-center">
                        ...
                        <span className="sm:hidden text-black mr-2">•</span>
                        <span className="text-sm sm:text-base">
                          Embedding Search + Retrieval Bot (Level 3)
                        </span>
                      </li>
                      <li className="flex items-center">
                        <span className="hidden sm:inline text-green-500 mr-2">
                        ...
                        <span className="sm:hidden text-black mr-2">•</span>
                        <span className="text-sm sm:text-base">
                          Memory-Augmented Assistant (Level 4)
                        </span>
                      </li>
                      <li className="flex items-center">
                        <span className="hidden sm:inline text-green-500 mr-2">
                        ...
                        <span className="sm:hidden text-black mr-2">•</span>
                        <span className="text-sm sm:text-base">
                          LangChain Agent with Multi-Step Planning (Level 5)
                        </span>
                      </li>
                      <li className="flex items-center">
                        <span className="hidden sm:inline text-green-500 mr-2">
                        ...
                        <span className="sm:hidden text-black mr-2">•</span>
                        <span className="text-sm sm:text-base">
                          LangGraph with Multi-Agent Roles (Level 6)
                        </span>
                      </li>
                      <li className="flex items-center">
                        <span className="hidden sm:inline text-green-500 mr-2">
                        ...
                        <span className="sm:hidden text-black mr-2">•</span>
                        <span className="text-sm sm:text-base">
                          API-Enhanced Reasoning Agent (Level 7)
                        </span>
                      </li>
                      <li className="flex items-center">
                        <span className="hidden sm:inline text-green-500 mr-2">
                        ...
                        <span className="sm:hidden text-black mr-2">•</span>
                        <span className="text-sm sm:text-base">
                          Full-stack AI SaaS Agent App (Level 8)
                        </span>
                      </li>
                    </ul>
                  </div>
          ...
          <div className="bg-white p-6 mt-30 rounded-lg shadow-md border border-gray-200 lg:sticky lg:top-22">
            ...
            <ul className="space-y-3 mb-6">
              <li className="flex items-center text-sm sm:text-base">
                ...
                <strong>127&nbsp;</strong> Learners enrolled
              </li>
              <li className="flex items-center text-sm sm:text-base">
                <div className="bg-gray-100 rounded-full p-1.5 mr-3">
