...
export default function MERNStackMasterclass() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        window.open('https://chat.whatsapp.com/FJ4guBwP9zV5X9Jsh85a4P', '_blank');
      }, 500);
    }, 300);
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:block hidden lg:w-3/5 p-8 rounded-lg shadow-lg border border-gray-200 overflow-hidden">
            <h1 className="text-2xl font-bold mb-4">
              Introduction to Full Stack Engineering - Build Industry-Ready Web Applications
            </h1>
      ...
      <div className="flex flex-col md:flex-row">
        <div className="md:w-2/3 w-full">
          <div className="bg-white my-6 block md:hidden">
            <span className="font-bold">MERN Stack Full Development Masterclass</span>
          ...
          <div className="bg-white my-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-700 leading-relaxed">
                    Understand what Full Stack Development means and the complete 3-tier architecture (Frontend, Backend, Database)
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-purple-50 to-violet-50 rounded-lg border border-purple-100">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-700 leading-relaxed">
                    See a live demonstration of how frontend and backend interact through APIs and database operations
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg border border-orange-100">
                ...
                <div className="flex-1">
                  <p className="text-sm text-gray-700 leading-relaxed">
                    Get a complete roadmap for becoming an industry-ready full stack developer with project-based learning
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-100">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-700 leading-relaxed">
                      Complete step-by-step roadmap covering HTML, CSS, JavaScript, React, Node.js, Express, MongoDB, APIs, Authentication, and Deployment. 
                      Your guide to becoming industry-ready.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-purple-50 to-violet-50 rounded-lg border border-purple-100">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-gray-900 mb-1">Certificate of Participation</h3>
                    <p className="text-sm text-gray-700 leading-relaxed">
                      Get a professional certificate showcasing your commitment to learning full stack development. 
                ...
                <div className="flex items-start gap-4 p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-100">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-gray-900 mb-1">Project Ideas & Resources</h3>
                    <p className="text-sm text-gray-700 leading-relaxed">
                      Access to curated project ideas like Netflix, Zomato, and Trello clones with starter templates and best practices. 
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-md">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-700 leading-relaxed">Students and beginners who want to start their journey in web development and become full stack developers.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-700 leading-relaxed">Frontend or backend developers looking to expand their skills and become full stack developers.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-700 leading-relaxed">Anyone interested in building complete web applications from scratch and understanding how they work.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-700 leading-relaxed">Professionals wanting to transition into tech or enhance their career with full stack development skills.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="my-12 rounded-lg">
            ...
            <div className="text-base text-gray-700 leading-relaxed mb-1">
              <p className="mb-4">
                This is a <strong>free live webinar</strong> designed to give you a comprehensive introduction to Full Stack Development. You&apos;ll understand what it means to work on both frontend and backend, and how modern web applications are built from scratch.
              </p>
              
              <p className="mb-4">
                <strong>Industry-Ready Skills:</strong> Learn the technologies and practices used by top tech companies. Understand the MERN stack (MongoDB, Express.js, React, Node.js) and how it powers real-world applications like Netflix, Airbnb, and more.
              </p>

              <p className="mb-4">
                <strong>Practical Learning Approach:</strong> This isn&apos;t just theory. You&apos;ll see live demonstrations of how frontend communicates with backend, how APIs work, and how data flows through a web application. We&apos;ll show you a real working project.
              </p>

              <p className="mb-4">
                <strong>Clear Career Path:</strong> Get a detailed roadmap showing exactly what to learn, in what order, and how to build projects that make you stand out. Learn how to create a portfolio that gets you hired.
              </p>
          ...
          <div className="my-12">
            <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 my-4">
              ...
              <a
                href="https://wa.me/917696433339?text=Hi%2C%20I%20want%20to%20know%20more%20about%20the%20MERN%20Stack%20Masterclass"
                target="_blank"
