...
export default function AIAgentMasterclass() {
  ...
  const copyWhatsAppLink = async () => {
    const link = "https://chat.whatsapp.com/GpsHLyzn8CkJwqiTAbUvvy";
    try {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        window.open('https://chat.whatsapp.com/GpsHLyzn8CkJwqiTAbUvvy', '_blank');
      }, 500);
    }, 300);
  ...
  useEffect(() => {
    ...
    const countDownDate = new Date("January 4, 2026 12:00:00").getTime();
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-800">4th January, 2026</span>
                </div>
        ...
        >
          ...
          >
            ...
            <div className="px-8 pb-8 text-center">
              ...
              <div className="mb-6 bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                    readOnly
                    value="https://chat.whatsapp.com/GpsHLyzn8CkJwqiTAbUvvy"
              ...
              <div className="space-y-3">
                <a
                  href="https://chat.whatsapp.com/GpsHLyzn8CkJwqiTAbUvvy"
                  target="_blank"
                  rel="noopener noreferrer"
