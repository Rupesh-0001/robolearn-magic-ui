...
export default function AIAgentMasterclass() {
  ...
  const copyWhatsAppLink = async () => {
    const link = "https://chat.whatsapp.com/FKnBFApK0dSF4bXoP4BP7F";
    try {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        window.open('https://chat.whatsapp.com/FKnBFApK0dSF4bXoP4BP7F', '_blank');
      }, 500);
    }, 300);
  ...
  useEffect(() => {
    ...
    const countDownDate = new Date("December 28, 2025 12:00:00").getTime();
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-800">28th December, 2025</span>
                </div>
        ...
        >
          ...
          >
            ...
            <div className="px-8 pb-8 text-center">
              ...
              <div className="mb-6 bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                    readOnly
                    value="https://chat.whatsapp.com/FKnBFApK0dSF4bXoP4BP7F"
              ...
              <div className="space-y-3">
                <a
                  href="https://chat.whatsapp.com/FKnBFApK0dSF4bXoP4BP7F"
                  target="_blank"
                  rel="noopener noreferrer"
