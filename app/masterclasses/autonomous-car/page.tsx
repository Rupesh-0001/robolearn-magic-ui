...
export default function AIAgentMasterclass() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    //       grp_link : "https://chat.whatsapp.com/LSnQM2vOpK6GvWQyl5OXfo"
    //     }),
    //   }).catch((emailError) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        window.open('https://chat.whatsapp.com/LSnQM2vOpK6GvWQyl5OXfo', '_blank');
      }, 500);
    }, 300);
  ...
  useEffect(() => {
    ...
    const countDownDate = new Date("October 5, 2025 19:00:00").getTime();
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-800">5th October, 2025</span>
                </div>
        ...
        >
          ...
          >
            ...
            <div className="px-8 pb-8 text-center">
              ...
              <div className="space-y-3">
                <a
                  href="https://chat.whatsapp.com/LSnQM2vOpK6GvWQyl5OXfo"
                  target="_blank"
                  rel="noopener noreferrer"
