...
export default function AIAgentMasterclass() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    //       grp_link : "https://chat.whatsapp.com/FJ4guBwP9zV5X9Jsh85a4P"
    //     }),
    //   }).catch((emailError) => {
  ...
  useEffect(() => {
    ...
    const countDownDate = new Date("October 19, 2025 19:00:00").getTime();
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-800">19th October, 2025</span>
                </div>
