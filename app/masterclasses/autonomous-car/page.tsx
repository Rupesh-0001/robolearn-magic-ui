...
export default function AIAgentMasterclass() {
  ...
  const copyWhatsAppLink = async () => {
    const link = "https://chat.whatsapp.com/G6CEmmE7wpn8FDWfhzbjTT";
    try {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        window.open('https://chat.whatsapp.com/G6CEmmE7wpn8FDWfhzbjTT', '_blank');
      }, 500);
    }, 300);
  ...
  useEffect(() => {
    ...
    const countDownDate = new Date("December 21, 2025 12:00:00").getTime();
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-gray-800">21st December, 2025</span>
                </div>
        ...
        >
          ...
          >
            ...
            <div className="px-8 pb-8 text-center">
              ...
              <div className="mb-6 bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                <div className="flex items-center gap-2">
                  <input
                    type="text"
                    readOnly
                    value="https://chat.whatsapp.com/G6CEmmE7wpn8FDWfhzbjTT"
              ...
              <div className="space-y-3">
                <a
                  href="https://chat.whatsapp.com/G6CEmmE7wpn8FDWfhzbjTT"
                  target="_blank"
                  rel="noopener noreferrer"
